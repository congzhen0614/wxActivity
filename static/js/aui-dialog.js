    ...
    AuiDialog.prototype = {
        ...
        create: function(params,callback) {
            ...
            if (!params.hasOwnProperty('msg')) {
                headerStyle = 'style="padding: 0.3rem 0.15rem 0 0.15rem"';
            }
            var headerHtml = params.title ? '<div class="aui-dialog-header"' + headerStyle + '>' + params.title + '</div>' : '<div class="aui-dialog-header"' + headerStyle + '>' + self.params.title + '</div>';
